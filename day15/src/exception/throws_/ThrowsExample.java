...
public class ThrowsExample {
	...
	/*
	 * 예외의 원인은 메서드 선언부가 아닌 호출부에 있을 경우
	 * 예외처리를 메소드 호출지역으로 떠넘기는 방식을 throws라고 한다
	 * 메서드 혹은 생성자 호출시 예외처리를 사용하고 싶다면 사용합니다.
	 */
	...
	public static void main(String[] args) {
		 /*
		  *  - throws가 붙어있는 메서드나 생성자호출시에는
		  *  try블럭 내부에서 호출해야 예외처리를 진행한다
		  */
		try {
			greet(3);
		}catch(Exception e) {
